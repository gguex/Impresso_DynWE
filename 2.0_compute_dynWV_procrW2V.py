...
# Build model
dyn_we.build_with_aligned_w2v("/home/gguex/Documents/data/impresso/by_year", ref_name="1997.txt", min_count=100,
                              window=5, size=300, sample=1e-5, negative=5, alpha=0.025, ns_exponent=0.75,
