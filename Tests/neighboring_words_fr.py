...
def neighbors_fr(word):
    ...
    synonyms = set(reduce(lambda x, y: x + y.lemma_names("fra"), related_synsets, []))
    ...
    lemmas_related_synsets = set(reduce(lambda x, y: x + y.lemmas("fra"), related_synsets, []))
